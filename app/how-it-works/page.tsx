...
export default function HowItWorksPage() {
  return (
    <div className="space-y-12">
      ...
      <Block title="Taking it to an appointment">
        <p>
          When a debate finishes you can turn it into one page of notes for a clinician: your own
          words quoted exactly, what you reported, and the questions worth asking. Download it as a
          PDF or copy it as text.
        </p>
        <p>
          It deliberately names no condition. A document that arrives naming one anchors the
          appointment before it starts, and this tool has no standing to do that — so it describes
          patterns and questions instead, and says on the page why the differential is missing. It
          also states plainly, in a box at the top and in the footer of every page, that it was
          generated by an AI tool from a few sentences and is not a clinical document.
        </p>
        <p>
          The PDF is built in your browser and never uploaded. Read it before you hand it over: if
          something in it is wrong, cross it out. You are the one who knows.
        </p>
      </Block>

      <Block title="What happens to what you write">
        <p>
          Your question is sent to Anthropic's API to generate the discussion — and again if you ask
          for appointment notes — and that is the whole journey. There is no account, no database, and no server-side log of what you asked. Close
